...
export class AuthRepository {
    ...
    async consultarRolesUsuario(user:iUsuario): Promise<iRolesPermisos>{
        ...
        // Paso 2: Crear el array de retorno (lista plana de permisos)
        ...
        for (const ur of usuarioRoles) {
            ...
            // Extraer los códigos de permisos y agregarlos al array plano
            rolesPermisosMap.push(...rolesPermisos.map(rp => rp.permisos.codigo));
        }
